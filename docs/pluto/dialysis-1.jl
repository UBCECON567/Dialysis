...
begin
	...
	Base.parse(::Type{S}, x::S) where S <: AbstractString = x 
	
	# a version of parse that works for the date formats in this data
	Base.parse(::Type{Dates.Date}, x::AbstractString) = occursin(r"\D{3}",x) ? Date(x, "dduuuyyyyy") : Date(x,"m/d/y")
end
...
git-tree-sha1 = "99b3935270a54b09c7ade82fe5646b87cadace23"
repo-rev = "master"
repo-url = "https://github.com/UBCECON567/Dialysis"
